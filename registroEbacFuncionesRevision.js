...
function agregarAlumno(){
 ...
 //var seguro = prompt("Introduce el Numero de seguro social si tiene el alumno en caso contrario escribe NO");

 var nuevoAlumno = {nombre: nombre, edad: edad, residencia: residencia, programa: programa, correo: correo, telefono: telefono};
